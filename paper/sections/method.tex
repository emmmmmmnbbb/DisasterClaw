...
Because the matched E1/E11 suites record zero strict success and no reinspection trigger, we treat localization, segmentation, planning, and memory as implementation scaffolding rather than as claimed sources of navigation or judgment gains.
