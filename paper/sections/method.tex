...
YOLO-style detection~\cite{redmon2016you}, segmentation, and a vision-language fallback provide candidate evidence.
Because E1 shows low success and no strict-SR improvement from these additions, we treat them as implementation scaffolding and analyze their failures rather than attributing navigation gains to them.
