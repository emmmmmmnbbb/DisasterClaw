...
Third, an event-disjoint localization U-Net substantially improves building proposal quality relative to the strict YOLO detector, but the end-to-end reinspection suite must still be judged by navigation and trigger statistics, not by localization metrics alone.
...
\begin{itemize}
    ...
    \item an honest empirical account of calibration, temporal fusion, localization scaffolding, and low-SR navigation results under a leakage-safe evaluation protocol.
\end{itemize}
