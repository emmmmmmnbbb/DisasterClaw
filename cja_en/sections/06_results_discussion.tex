...
For the paired cruise-to-floor comparison, 2,696 building outcomes change from incorrect to correct and 261 change from correct to incorrect, a net gain of 2,435 on this development population. The same nominally closer view therefore supplies useful detail and harmful changes. These are binary ChangeOS diagnostics; the archived four-class results in Appendix~\ref{app:historical} belong to a different backend and are not pooled with them. More importantly, building-level gains do not by themselves imply better task answers.
