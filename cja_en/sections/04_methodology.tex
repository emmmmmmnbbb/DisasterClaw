...
\caption{Operator console displaying georeferenced scene, simulated vehicle state, task, perception evidence, decisions, and episode log. The screenshots document implemented functions; they are not quantitative evidence.}
\label{fig:console}
\end{figure}
